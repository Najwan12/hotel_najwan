            ...
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li><a href="settings.php"><i class="fa fa-gear fa-fw"></i> Peraturan</a>
                        </li>
                        <li class="divider"></li>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a href="roombook.php"><i class="fa fa-bar-chart-o"></i> Booking Kamar</a>
                    </li>
                    <li>
                        <a href="payment.php"><i class="fa fa-qrcode"></i> Pembayaran</a>
                    </li>
                    <li>
                        <a  href="profit.php"><i class="fa fa-qrcode"></i> Laba</a>
                    </li>
                    <li>
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
											...
											<button class="btn btn-default" type="button">
												 Booking Kamar Baru  <span class="badge"><?php echo $c ; ?></span>
											</button>
											</a>
                                        </h4>
                                    </div>
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
											...
											<button class="btn btn-primary" type="button">
												 Kamar yang dipesan <span class="badge"><?php echo $r ; ?></span>
											</button>
                                ...
                                <div class='modal-dialog'>
                                    <div class='modal-content'>
                                        <div class='modal-header'>
                                            ...
                                            <h4 class='modal-title' id='myModalLabel'>Ganti username dan password </h4>
                                        </div>
										<form method='post>
